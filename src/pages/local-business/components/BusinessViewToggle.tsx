...
function BusinessViewToggle({ mode, onToggle }: BusinessViewToggleProps) {
  ...
  return (
    <button
      ...
      onClick={onToggle}
      className="border-gray-2 bg-white text-gray-4 flex h-[29px] items-center gap-1 rounded-full border px-3 py-1.5 text-[14px] leading-none font-normal whitespace-nowrap cursor-pointer"
    >
